...
const int IID_BOARD = 15;
const int IID_WHITEPLAYER = 16;
const int IID_BLACKPLAYER = 17;
const int IID_STAR = 18;
...
const int VIEW_WIDTH = 19; //64; //256;
const int VIEW_HEIGHT = 19; //64;	 //256;

const int SPRITE_WIDTH = 4; //VIEW_WIDTH/16;
const int SPRITE_HEIGHT = 4; //VIEW_HEIGHT/16;
